...
public class hospital_DRIVER
{
   public static void main(String[] args) {
	        ...
	        try{
	            Connection connection = DriverManager.getConnection("jdbc:mysql://localhost:330/hospital", "root", "Nil@m2001");
	    ...
	    public static void bookAppointment(Patient patient, Doctor doctor, Connection connection, Scanner scanner){
	        ...
	        if(patient.getPatientById(patientId) && doctor.getDoctorById(doctorId)){
	            if(checkDoctorAvailability(doctorId, appointmentDate, connection)){
	                ...
	                System.out.println("Doctor not available on this date...doctor already appointed!!");
	            }
	        }else{
